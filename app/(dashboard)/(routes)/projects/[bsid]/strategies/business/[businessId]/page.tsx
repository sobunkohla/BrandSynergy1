      ...
      <div className="container space-y-6 ">
        <div className="space-y-2  ">
          ...
          <Link href={`/projects/${params.bsid}/strategies/business/`}>
            ...
            <Link href={`/projects/${params.bsid}/strategies/business/new/${params.businessId}`}>
            <Button className="bg-orange-500">
                Edit Strategy
            </Button>
            </Link>
        ...
        <Heading description="get insight from the worlds best sources " title="Advice" icon={FaUser} bgColor="bg-orange-200" iconColor="text-orange-600" />
        <div className="bg-gray-200 rounded-lg shadow-inner py-12 px-10 max-h-[70vh] overflow-y-scroll   ">
            {/* Render your advice content here */}
            {businessStrategy.advice}
          </div>
      </div>
    </div>
  );
